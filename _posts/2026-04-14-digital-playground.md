...
### AI
Using AI has saved me a lot of time but it has also caused a lot of issues, mostly with badly generated code which was worse with ChatGPT than copilot but there was a lot of clean-up needed after each time that I used it and ChatGPT especially sent me down a lot of rabbit holes when I was using it to troubleshoot odd errors I was getting while still learning the technologies. There is still some code that I added using AI that I need to go through and verify, especially in the lit-client and having seen the results of the AI-generated tests, I will be a lot more vigilant when using AI to generate code.
